...
fParticlePairsInfoMC(particlePairsInfo) {
    SetReportName(name);  
    switch (key2) {
        case 'a':
...
void BmnLambdaQaReport::PrintEventInfo() {
    ...
    if (kTRUE == fUseMCFile ) {
            ...
            Out() << setprecision(8) << defaultfloat << "<h1> Number of lambda:\n" << HM()->H1("numberOfLambdas_LambdaQa")->GetEntries() << "</h1>" << endl;
            Out() << setprecision(8) << defaultfloat  << "<h1> Number of reconstructable lambda:\n" << HM()->H1("numberOfReconstructableLambdas_LambdaQa")->GetEntries() << "</h1>" << endl;
            ...
            Out() << setprecision(8) << defaultfloat << "<h1> Number of particle pairs reconstructed by MC tracks:\n" << HM()->H1("numberOfMCReconstructedParticlePairsQA")->GetEntries() << "</h1>" << endl;
            Out() << setprecision(8) << defaultfloat << "<h1> Number of particle pairs reconstructed by MC tracks being lambda:\n" << HM()->H1("numberOfMCReconstructedLambdasQA")->GetEntries() << "</h1>" << endl;
            ...
            if (NULL == fParticlePairsInfoMC) {
                Fatal("Init", ": No particle pairs info MC array!");
            }
            
            Out() << "<h1> <font color='6f00ff'> Kinematic cuts for MC are: </font></h1>" << endl;
            Out() << setprecision(8) << defaultfloat << "<h1>" << ((BmnParticlePairsInfo*)(fParticlePairsInfoMC->At(0)))->getMomPart1Min()  << " < P_1 < " << ((BmnParticlePairsInfo*)(fParticlePairsInfoMC->At(0)))->getMomPart1Max() << " (GeV/c)" <<  "</h1>" << endl;
            Out() << setprecision(8) << defaultfloat << "<h1>" << ((BmnParticlePairsInfo*)(fParticlePairsInfoMC->At(0)))->getMomPart2Min()  << " < P_2 < " << ((BmnParticlePairsInfo*)(fParticlePairsInfoMC->At(0)))->getMomPart2Max() << " (GeV/c)" <<  "</h1>" << endl;
            Out() << setprecision(8) << defaultfloat << "<h1>" << ((BmnParticlePairsInfo*)(fParticlePairsInfoMC->At(0)))->getEtaPart1Min()  << " < Eta_1 < " << ((BmnParticlePairsInfo*)(fParticlePairsInfoMC->At(0)))->getEtaPart1Max() << "" <<  "</h1>" << endl;
            Out() << setprecision(8) << defaultfloat << "<h1>" << ((BmnParticlePairsInfo*)(fParticlePairsInfoMC->At(0)))->getEtaPart2Min()  << " < Eta_2 < " << ((BmnParticlePairsInfo*)(fParticlePairsInfoMC->At(0)))->getEtaPart2Max() << "" <<  "</h1>" << endl;
            Out() << "<h1> <font color='6f00ff'> Geometrical cuts for MC are: </font></h1>" << endl;
            Out() << setprecision(8) << defaultfloat << "<h1>" << ((BmnParticlePairsInfo*)(fParticlePairsInfoMC->At(0)))->getDCAPart1Min()  << " < DCA1 < " << ((BmnParticlePairsInfo*)(fParticlePairsInfoMC->At(0)))->getDCAPart1Max() << " cm" <<  "</h1>" << endl;
            Out() << setprecision(8) << defaultfloat << "<h1>" << ((BmnParticlePairsInfo*)(fParticlePairsInfoMC->At(0)))->getDCAPart2Min()  << " < DCA2 < " << ((BmnParticlePairsInfo*)(fParticlePairsInfoMC->At(0)))->getDCAPart2Max() << " cm" <<  "</h1>" << endl;
            Out() << setprecision(8) << defaultfloat << "<h1>" << ((BmnParticlePairsInfo*)(fParticlePairsInfoMC->At(0)))->getDCA12Min()  << " < DCA_12 < " << ((BmnParticlePairsInfo*)(fParticlePairsInfoMC->At(0)))->getDCA12Max() << " cm" <<  "</h1>" << endl;
            Out() << setprecision(8) << defaultfloat << "<h1>" << ((BmnParticlePairsInfo*)(fParticlePairsInfoMC->At(0)))->getPathMin()  << " < PATH < " << ((BmnParticlePairsInfo*)(fParticlePairsInfoMC->At(0)))->getPathMax() << " cm" <<  "</h1>" << endl;
            cout << fParticlePairsInfoMC->GetEntriesFast() << endl;
    }       
         
    if (kTRUE == fUseRecoFile ) { 
        Out() << setprecision(8) << defaultfloat << "<h1> Number of reconstructed particle pairs:\n" << HM()->H1("numberOfReconstructedParticlePairsQA")->GetEntries() << "</h1>" << endl;  
        ...
        Out() << setprecision(8) << defaultfloat << "<h1>" << ((BmnParticlePairsInfo*)(fParticlePairsInfoReco->At(0)))->getMomPart1Min()  << " < P_1 < " << ((BmnParticlePairsInfo*)(fParticlePairsInfoReco->At(0)))->getMomPart1Max() << " (GeV/c)" <<  "</h1>" << endl;
        Out() << setprecision(8) << defaultfloat << "<h1>" << ((BmnParticlePairsInfo*)(fParticlePairsInfoReco->At(0)))->getMomPart2Min()  << " < P_2 < " << ((BmnParticlePairsInfo*)(fParticlePairsInfoReco->At(0)))->getMomPart2Max() << " (GeV/c)" <<  "</h1>" << endl;
        Out() << setprecision(8) << defaultfloat << "<h1>" << ((BmnParticlePairsInfo*)(fParticlePairsInfoReco->At(0)))->getEtaPart1Min()  << " < Eta_1 < " << ((BmnParticlePairsInfo*)(fParticlePairsInfoReco->At(0)))->getEtaPart1Max() << "" <<  "</h1>" << endl;
        Out() << setprecision(8) << defaultfloat << "<h1>" << ((BmnParticlePairsInfo*)(fParticlePairsInfoReco->At(0)))->getEtaPart2Min()  << " < Eta_2 < " << ((BmnParticlePairsInfo*)(fParticlePairsInfoReco->At(0)))->getEtaPart2Max() << "" <<  "</h1>" << endl;
        Out() << "<h1> <font color='90ff00'> Geometrical cuts for reco are: </font></h1>" << endl;
        Out() << setprecision(8) << defaultfloat << "<h1>" << ((BmnParticlePairsInfo*)(fParticlePairsInfoReco->At(0)))->getDCAPart1Min()  << " < DCA1 < " << ((BmnParticlePairsInfo*)(fParticlePairsInfoReco->At(0)))->getDCAPart1Max() << " cm" <<  "</h1>" << endl;
        Out() << setprecision(8) << defaultfloat << "<h1>" << ((BmnParticlePairsInfo*)(fParticlePairsInfoReco->At(0)))->getDCAPart2Min()  << " < DCA2 < " << ((BmnParticlePairsInfo*)(fParticlePairsInfoReco->At(0)))->getDCAPart2Max() << " cm" <<  "</h1>" << endl;
        Out() << setprecision(8) << defaultfloat << "<h1>" << ((BmnParticlePairsInfo*)(fParticlePairsInfoReco->At(0)))->getDCA12Min()  << " < DCA_12 < " << ((BmnParticlePairsInfo*)(fParticlePairsInfoReco->At(0)))->getDCA12Max() << " cm" <<  "</h1>" << endl;
        Out() << setprecision(8) << defaultfloat << "<h1>" << ((BmnParticlePairsInfo*)(fParticlePairsInfoReco->At(0)))->getPathMin()  << " < PATH < " << ((BmnParticlePairsInfo*)(fParticlePairsInfoReco->At(0)))->getPathMax() << " cm" <<  "</h1>" << endl;
    } 

...
void BmnTrackingQaExp::CreateHistograms() {
    ...
    UInt_t nofBinsC = 40;
    UInt_t maxXC = nofBinsC + 1;
    CreateH1("Nof_GlobalTracks", "Global tracks per event", "Yield", nofBinsC, 1, maxXC);
    CreateH1("Nof_GemTracks", "GEM tracks per event", "Yield", nofBinsC, 1, maxXC);
    CreateH1("Nof_GemHits", "GEM hits per event", "Yield", nofBinsC, 1, maxXC);
    CreateH1("Nof_SilTracks", "Si tracks per event", "Yield", nofBinsC, 1, maxXC);
    CreateH1("Nof_SilHits", "Si hits per event", "Yield", nofBinsC, 1, maxXC);
    ...
    CreateH1("VertX", "V_{x}, cm", "Counter", 300, -4.0, 4.0);
    CreateH1("VertY", "V_{y}, cm", "Counter", 300, -4.0, 4.0);
    CreateH1("VertZ", "V_{z}, cm", "Counter", 300, -4.0, +4.0);
    CreateH2("VertXY", "V_{x}, cm", "V_{y}, cm", "", 100, -5.0, 5.0, 100, -5.0, 5.0);
    CreateH2("VertX_vs_Ntracks", "Number of tracks", "V_{x}, cm", "", 100, 0, 100, 300, -4.0, 4.0);
    CreateH2("VertY_vs_Ntracks", "Number of tracks", "V_{y}, cm", "", 100, 0, 100, 300, -4.0, 4.0);
    CreateH2("VertZ_vs_Ntracks", "Number of tracks", "V_{z}, cm", "", 100, 0, 100, 300, -4.0, +4.0);

...
BmnFieldConst::BmnFieldConst(const char* name, Double_t xMin, 
...
{
  if ( ! fieldPar ) {
    cerr << "-W- BmnFieldConst::BmnFieldConst: empty parameter container!"
	 << endl;
    fType=0;
  }
  else {
...
// -----   Set field region   ----------------------------------------------
void BmnFieldConst::SetFieldRegion(Double_t xMin, Double_t xMax, 

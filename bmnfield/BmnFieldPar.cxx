...
void BmnFieldPar::SetParameters(FairField* field) {
  ...
  if ( fType == 0 ) {                                 // constant field
    ...
    if (fieldMap->GetType()==kTypeDistorted) {  // BmnFieldMapDistorted case
      fDistortionFilename = ((BmnFieldMapDistorted*)fieldMap)->GetDistortionFilename();
      fParentName = ((BmnFieldMapDistorted*)fieldMap)->GetParent()->GetName();
      fTypeOfParent = ((BmnFieldMapDistorted*)fieldMap)->GetParent()->GetType();
    }
  }

...
int compare_db()
{
    ...
    UniSearchCondition* searchConditionPeriod = new UniSearchCondition(columnStartPeriod, conditionGreater, 0);
    arrayConditions.Add((TObject*)searchConditionPeriod);
    //UniSearchCondition* searchConditionSerial = new UniSearchCondition(columnDCSerial, conditionNull);
    //arrayConditions.Add((TObject*)searchConditionSerial);
    //UniSearchCondition* searchConditionName = new UniSearchCondition(columnParameterName, conditionEqual, (TString)"inl");

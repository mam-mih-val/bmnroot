...
/**  DCH2.h
 **
 ** Defines the active detector DCH2. Constructs the geometry and
 ** registeres MCPoints.
 **/
...
//------------------------------------------------------------------------------------------------------------------------
class BmnDch2 : public FairDetector
{
...
public:
  	...
  	BmnDch2(const char* name, Bool_t active);

	BmnDch2();
	virtual ~BmnDch2();

	// Defines the action to be taken when a step is inside the
	// active volume. Creates BmnDch2Points and adds them to the collection.
...
private:
	...
	// Adds a BmnDch2Point to the HitCollection
  	BmnDch2Point* AddHit(Int_t trackID, Int_t detID, TVector3 pos, Double_t radius, TVector3 mom, Double_t time, 
...
//------------------------------------------------------------------------------------------------------------------------
inline void BmnDch2::ResetParameters() 
{
	fTrackID = -1;
	fVolumeID = fwheel = 0;

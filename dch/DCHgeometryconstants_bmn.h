...
const Double_t DCH1_Xpos[3] = {DCH1_Zpos[0]*tanpipeangle,DCH1_Zpos[1]*tanpipeangle,DCH1_Zpos[2]*tanpipeangle};
//const Double_t DCH1_Xpos[3] = {DCH1_Zpos[0]*tanpipeangle,DCH1_Zpos[1]*tanpipeangle,21.};
const Double_t DCH2_Ypos = 0.0;
const Double_t DCH2_Zpos[3] = {650.0,748.35,748.35}; //cm
const Double_t DCH2_Xpos[3] = {DCH2_Zpos[0]*tanpipeangle,DCH2_Zpos[1]*tanpipeangle,DCH2_Zpos[2]*tanpipeangle};
//const Double_t DCH2_Xpos[3] = {DCH2_Zpos[0]*tanpipeangle,DCH2_Zpos[1]*tanpipeangle,25.};

...
Bool_t BmnSiBT::ProcessHits(FairVolume* vol) {
	...
	fPosOut = pos - corr_step;
        ...
        BmnSiBTPoint *p = AddHit(fTrackID, fVolumeID,
                                fPosIn, fPosOut,
                                fMomIn, fMomOut,
...
//------------------------------------------------------------------------------
BmnSiBTPoint* BmnSiBT::AddHit(Int_t trackID, Int_t detID,
    ...
    new(clref[size]) BmnSiBTPoint(trackID, detID,

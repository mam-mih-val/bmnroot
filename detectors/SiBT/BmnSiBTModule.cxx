...
Bool_t BmnSiBTModule::AddRealPointFullOne(Double_t x, Double_t y, Double_t z,
    ...
    if( IsPointInsideModule(x, y) ) {
        ...
        if(Verbosity) cerr << "WARNING: BmnSiBTModule::AddRealPointFullOne(): Point (" << x << " : " << y << " : " << z << ") is out of the readout plane or inside a dead zone\n";
        return false;
    }
}

//Add single point without smearing and avalanch effects
Bool_t BmnSiBTModule::AddRealPointSimple(Double_t x, Double_t y, Double_t z,
                                        Double_t px, Double_t py, Double_t pz, Double_t signal, Int_t refID) {
    ...
    if( IsPointInsideModule(x, y) ) {
        ...
        if(Verbosity) cerr << "WARNING: BmnSiBTModule::AddRealPointSimple(): Point (" << x << " : " << y << ") is out of the readout plane or inside a dead zone\n";
        return false;
    }
}

StripCluster BmnSiBTModule::MakeCluster(Int_t layer_num, Double_t xcoord, Double_t ycoord, Double_t signal, Double_t radius) {
...
Bool_t BmnSiBTModule::SearchIntersectionPoint(Double_t &x, Double_t &y, Double_t strip_pos_layerA, Double_t strip_pos_layerB, Int_t layerA_index, Int_t layerB_index) {

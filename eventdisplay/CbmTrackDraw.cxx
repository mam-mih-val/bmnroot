// -------------------------------------------------------------------------
// -----                        CbmTrackDraw source file               -----
// -----                  Created 02/12/15  by K. Gertsenberger        -----
// -------------------------------------------------------------------------

#include "CbmTrackDraw.h"
#include "CbmTrack.h"
#include "CbmStack.h"
...
// -----   Default constructor   -------------------------------------------
CbmTrackDraw::CbmTrackDraw()
    : FairTask("CbmTrackDraw", 0),
      fTrackList(NULL),
      fTrPr(NULL),
      fEventManager(NULL),
      fEveTrList(NULL),
...
CbmTrackDraw::CbmTrackDraw(const char* name, Int_t iVerbose)
...
InitStatus CbmTrackDraw::Init()
{
    if (fVerbose > 1)
        cout<<"CbmTrackDraw::Init()"<<endl;
...
// -------------------------------------------------------------------------
void CbmTrackDraw::Exec(Option_t* option)
{
    if (!IsActive())
        return;
...
// -------------------------------------------------------------------------
void CbmTrackDraw::SetParContainers()
{
}

// -------------------------------------------------------------------------
void CbmTrackDraw::Finish()
{
}

// -------------------------------------------------------------------------
void CbmTrackDraw::Reset()
{
...
TEveTrackList* CbmTrackDraw::GetTrGroup(TParticle* P)
{
    fTrList = 0;

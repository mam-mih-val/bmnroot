...
*/
#ifndef OnlineEventManager_H
#define OnlineEventManager_H
...
class OnlineEventManager : public TEveEventManager
{
  public:
    ...
    static OnlineEventManager* Instance();
    OnlineEventManager();
    virtual ~OnlineEventManager();
    virtual void Open();
  ...
  private:
    ...
    static OnlineEventManager* fgRinstance; //!
    ...
    OnlineEventManager(const OnlineEventManager&);
    OnlineEventManager& operator=(const OnlineEventManager&);

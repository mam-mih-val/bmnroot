...
public:
    ...
    virtual Int_t AddPointToStation(Double_t xcoord, Double_t ycoord, Double_t zcoord, Double_t dEloss, Int_t refID) = 0;
...
//Exeptions --------------------------------------------------------------------
class Station_Exeption {
public:
    Station_Exeption(TString message) {
        std::cout << "Station_Exeption::" << message << "\n";
    }
};
//------------------------------------------------------------------------------

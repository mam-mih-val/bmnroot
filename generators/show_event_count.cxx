...
int main(int argc, char** argv)
{
    ...
    if (argc > 1)
    {
        ...
        {
            cout<<"The utility shows event count for the given generator file"<<endl
               <<"The first parameter: case-insensitive generator name (urqmd, hsd (phsd), qgsm (laqgsm,dcm-gsqm)"<<endl
               <<"The second parameter: generator file path"<<endl<<"Example:"<<endl<<"show_event_count dcmqgsm /eos/nica/bmn/sim/DQGSM/"<<endl;
    ...
    if (argc != 3)
    {
        cout<<"The ShowEventCount utility takes 2 parameters: "<<endl<<"1st - generator name; 2nd - generator file path"<<endl;
        return -1;
    }

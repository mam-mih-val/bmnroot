...
TH1F* CreateHistogram1(const char* name, const TString &suffix, const char *xtitle, int nbin,
									    Float_t firstBin, Float_t lastBin)
{
 TString fullName = TString(name) + suffix;
 return CreateHistogram1(fullName.Data(), xtitle, nbin, firstBin, lastBin);
}
TH2F* CreateHistogram2(const char* name, const TString &suffix, const char* xtitle, const char* ytitle, 
			int nbinx, Float_t firstBinX, Float_t lastBinX, int nbiny, Float_t firstBinY, Float_t lastBinY)
{
 TString fullName = TString(name) + suffix;
 return CreateHistogram2(fullName.Data(), xtitle, ytitle, nbinx, firstBinX, lastBinX, nbiny, firstBinY, lastBinY);
}
TH3F* CreateHistogram3(const char* name, const TString &suffix, const char* xtitle, const char* ytitle, 
			const char* ztitle, 
			int nbinx, Float_t firstBinX, Float_t lastBinX, int nbiny, Float_t firstBinY, Float_t lastBinY,
			int nbinz, Float_t firstBinZ, Float_t lastBinZ)
{
 TString fullName = TString(name) + suffix;
 return CreateHistogram3(fullName.Data(), xtitle, ytitle, ztitle, nbinx, firstBinX, lastBinX, nbiny, firstBinY, lastBinY,

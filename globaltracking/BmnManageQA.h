...
TH1F* CreateHistogram1(const char* name, const TString&, const char* xtitle, int nbin, Float_t firstBin, Float_t lastBin);
TH2F* CreateHistogram2(const char* name, const TString&, const char* xtitle, const char* ytitle, 
			int nbinx, Float_t firstBinX, Float_t lastBinX, int nbiny, Float_t firstBinY, Float_t lastBinY);
TH3F* CreateHistogram3(const char* name,const TString&,  const char* xtitle, const char* ytitle, const char* ztitle,
			int nbinx, Float_t firstBinX, Float_t lastBinX, int nbiny, Float_t firstBinY, Float_t lastBinY,
			int nbinz, Float_t firstBinZ, Float_t lastBinZ);

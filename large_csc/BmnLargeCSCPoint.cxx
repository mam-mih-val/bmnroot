...
BmnLargeCSCPoint::BmnLargeCSCPoint()
: FairMCPoint(),
  fX_out(0.0),
  fY_out(0.0),
  fZ_out(0.0),
...
BmnLargeCSCPoint::BmnLargeCSCPoint(Int_t trackID, Int_t detID,
...
void BmnLargeCSCPoint::Print(const Option_t* opt) const {
    cout << "-I- BmnLargeCSCPoint: LargeCSC point for track " << fTrackID << " in detector " << fDetectorID << endl;

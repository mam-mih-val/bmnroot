#ifndef BMNLARGECSCPOINT_H
#define BMNLARGECSCPOINT_H

#include "FairMCPoint.h"

class BmnLargeCSCPoint : public FairMCPoint {
...
public:
    ...
    **/
    BmnLargeCSCPoint(Int_t trackID, Int_t detID,
                TVector3 posIn, TVector3 posOut,
                TVector3 momIn, TVector3 momOut,
                Double_t tof, Double_t length, Double_t eLoss,
                Int_t isPrimary, Double_t charge, Int_t pdgId);

    BmnLargeCSCPoint(const BmnLargeCSCPoint& point) { *this = point; };

    BmnLargeCSCPoint();

    virtual ~BmnLargeCSCPoint();
...
protected:
    ...
    ClassDef(BmnLargeCSCPoint,1)
};

#endif /* BMNLARGECSCPOINT_H */

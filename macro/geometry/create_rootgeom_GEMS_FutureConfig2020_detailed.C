...
void create_rootgeom_GEMS_FutureConfig2020_detailed() {
    ...
    //for(Int_t istation = 0; istation < 1; ++istation) {
        ...
        TGeoVolume *layers2 = CreateLayersForModule_Station163x45(TString("layer3_")+station->GetName());
        TGeoVolume *layers3 = CreateLayersForModule_Station163x45(TString("layer4_")+station->GetName());

        TGeoVolume *frame_lower = CreateFrameForHalfPlane_Station163x45(TString("frame_lower_")+station->GetName());

...
const Bool_t YStationRotations[NStations] = {false/*0*/, false/*1*/, false/*2*/, false/*3*/, false/*4*/, true/*5*/};
...
void create_rootgeom_GEMS_RunSpring2017_detailed() {
    ...
    if(1) {
        ...
        TGeoVolume *layers0 = CreateLayersForModule_Station66x41(TString("layer0_")+station->GetName());
        TGeoVolume *layers1 = CreateLayersForModule_Station66x41(TString("layer1_")+station->GetName());
        ...
        TGeoCombiTrans *module0_transform = new TGeoCombiTrans();
            module0_transform->SetTranslation(XModuleShifts[stationNum][0], YModuleShifts[stationNum][0], ZModuleShifts[stationNum][0]+(ZModuleSize_Station66x41+0.2)*0.5); //extended module
...
TGeoVolume *CreateLayersForModule_Station66x41(TString layer_name) {
    ...
    glueLayerBack_transf[0]->SetDz(+ZGEMSize_Station66x41*0.5 - copperLayer_ZSize*0.5 - glueLayer_ZSize*0.5 + layerBack_ZShift) ;
    ...
    epoxideLayerBack_transf[0]->SetDz(+ZGEMSize_Station66x41*0.5 - copperLayer_ZSize*0.5 - glueLayer_ZSize - epoxideLayer_ZSize*0.5 + layerBack_ZShift) ;
    ...
    honeycombLayerBack_transf[0]->SetDz(+ZGEMSize_Station66x41*0.5 - copperLayer_ZSize*0.5 - glueLayer_ZSize - epoxideLayer_ZSize - honeycombLayer_ZSize*0.5 + layerBack_ZShift) ;
    ...
    polyamideLayerBack_transf[0]->SetDz(+ZGEMSize_Station66x41*0.5 - copperLayer_ZSize*0.5 - glueLayer_ZSize - epoxideLayer_ZSize - honeycombLayer_ZSize - polyamideLayer_ZSize*0.5 + layerBack_ZShift) ;

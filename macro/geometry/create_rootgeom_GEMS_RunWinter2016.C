...
void SetStationPositionsAndModuleShifts() {
    ...
    for(Int_t iStation = 0; iStation < nStations; ++iStation) {
        XStationPositions[iStation] = BmnGemStationPositions_RunWinter2016::XStationPositions[iStation];
        YStationPositions[iStation] = BmnGemStationPositions_RunWinter2016::YStationPositions[iStation];
        ZStationPositions[iStation] = BmnGemStationPositions_RunWinter2016::ZStationPositions[iStation];
        ...
        for(Int_t iModule = 0; iModule < nMaxModules; ++iModule) {
            XModuleShifts[iStation][iModule] = BmnGemStationPositions_RunWinter2016::XModuleShifts[iStation][iModule];
            YModuleShifts[iStation][iModule] = BmnGemStationPositions_RunWinter2016::YModuleShifts[iStation][iModule];
            ZModuleShifts[iStation][iModule] = BmnGemStationPositions_RunWinter2016::ZModuleShifts[iStation][iModule];

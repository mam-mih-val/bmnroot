...
//root -l "create_rootgeom_ScWall_oldnames_no_hole_v1.C(0,0,900,0)"
...
//Global dimensions for ScWall in cm
...
void create_rootgeom_ScWall_oldnames_no_hole_v1(Double_t ScWall_Xpos=0,Double_t ScWall_Ypos=0,Double_t ScWall_Zpos=900,Double_t rotY=0) {
...
// -------   Geometry file name (output)   ---------------------------------
  const TString geoDetectorName = "ScWall_oldnames_no_hole";
  const TString geoDetectorVersion = "v1";

  Double_t ScWall_center_Zpos = ScWall_Zpos + ScWall_Z_size*TMath::Cos(rotY*TMath::DegToRad());//(900+0.5);//cm
  Double_t ScWall_center_Xpos = ScWall_Xpos + ScWall_Z_size*TMath::Sin(rotY*TMath::DegToRad());//cm
...
//Adding the ScWall mother volume to the global TOP Volume

...
void create_rootgeom_ScWall_oldnames_with_hole_with_box_v1(Double_t ScWall_Xpos=0,Double_t ScWall_Ypos=0,Double_t ScWall_Zpos=900,Double_t rotY=0) {
...
// -------   Geometry file name (output)   ---------------------------------
  const TString geoDetectorName = "ScWall_oldnames_with_hole_with_box";

...
void run_sim_bmn(TString inFile = "$VMCWORKDIR/macro/run/ArPb_3.2AGeV_mb_10.r12", TString outFile = "$VMCWORKDIR/macro/run/bmnsim_XeSn_10ev_run7.root",
                 Int_t nStartEvent = 0, Int_t nEvents = 10, enumGenerators generatorName = QGSM, Bool_t useRealEffects = kFALSE)
{
    TStopwatch timer;
    timer.Start();
    gDebug = 0;

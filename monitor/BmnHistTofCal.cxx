...
void BmnHistTofCal::FillFromDigi(DigiArrays *fDigiArrays) {
...
void BmnHistTofCal::Register(THttpServer *serv) {
    fServer = serv;
...
void BmnHistTofCal::SetDir(TFile* outFile, TTree* recoTree) {
    frecoTree = recoTree;
    fDir = NULL;
    if (outFile != NULL)
...
void BmnHistTofCal::DrawBoth() {
    BmnHist::DrawRef(can, &canPads);
}

BmnStatus BmnHistTofCal::SetRefRun(Int_t id) {
//    if (refID != id) {
...
void BmnHistTofCal::ClearRefRun() {
    for (auto pad : canPads){

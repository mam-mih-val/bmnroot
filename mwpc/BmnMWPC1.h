//------------------------------------------------------------------------------------------------------------------------
// -------------------------------------------------------------------------
// -----                         BmnMWPC1 header file                    -----
// -------------------------------------------------------------------------

/**  MWPC1.h
 **
 ** Defines the active detector MWPC1. Constructs the geometry and
 ** registeres MCPoints.
 **/
...
//------------------------------------------------------------------------------------------------------------------------
class BmnMWPC1 : public FairDetector
{
...
public:
  	...
  	BmnMWPC1(const char* name, Bool_t active);
...
private:
	...
	// Adds a BmnMWPC1Point to the HitCollection
  	BmnMWPC1Point* AddHit(Int_t trackID, Int_t detID, TVector3 pos, Double_t radius, TVector3 mom, Double_t time, 
...
//------------------------------------------------------------------------------------------------------------------------
inline void BmnMWPC1::ResetParameters() 
{
	fTrackID = -1;
	fVolumeID = fwheel = 0;

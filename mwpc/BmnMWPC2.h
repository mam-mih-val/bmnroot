//------------------------------------------------------------------------------------------------------------------------
// -------------------------------------------------------------------------
// -----                         BmnMWPC2 header file                    -----
// -------------------------------------------------------------------------

/**  MWPC2.h
 **
 ** Defines the active detector MWPC2. Constructs the geometry and
 ** registeres MCPoints.
 **/
...
//------------------------------------------------------------------------------------------------------------------------
class BmnMWPC2 : public FairDetector
{
...
public:
  	...
  	BmnMWPC2(const char* name, Bool_t active);

	BmnMWPC2();
	virtual ~BmnMWPC2();

	// Defines the action to be taken when a step is inside the
	// active volume. Creates BmnMWPC2Points and adds them to the collection.
...
private:
	...
	// Adds a BmnMWPC2Point to the HitCollection
  	BmnMWPC2Point* AddHit(Int_t trackID, Int_t detID, TVector3 pos, Double_t radius, TVector3 mom, Double_t time, 
...
//------------------------------------------------------------------------------------------------------------------------
inline void BmnMWPC2::ResetParameters() 
{
	fTrackID = -1;
	fVolumeID = fwheel = 0;

...
ClassImp(BmnMWPC2GeoPar)

BmnMWPC2GeoPar::BmnMWPC2GeoPar(const char* name,const char* title,const char* context)
...
BmnMWPC2GeoPar::~BmnMWPC2GeoPar(void) {
}

void BmnMWPC2GeoPar::clear(void) {
    if(fGeoSensNodes) delete fGeoSensNodes;
    if(fGeoPassNodes) delete fGeoPassNodes;
    fGeoSensNodes = fGeoPassNodes = 0x0; //AZ
}

void BmnMWPC2GeoPar::putParams(FairParamList* l) {
  if (!l) return;
...
Bool_t BmnMWPC2GeoPar::getParams(FairParamList* l) {
    if (!l) return kFALSE;

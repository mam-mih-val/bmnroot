//------------------------------------------------------------------------------------------------------------------------
// -------------------------------------------------------------------------
// -----                         BmnMWPC3 header file                    -----
// -------------------------------------------------------------------------

/**  MWPC3.h
 **
 ** Defines the active detector MWPC3. Constructs the geometry and
 ** registeres MCPoints.
 **/
...
//------------------------------------------------------------------------------------------------------------------------
class BmnMWPC3 : public FairDetector
{
...
public:
  	...
  	BmnMWPC3(const char* name, Bool_t active);

	BmnMWPC3();
	virtual ~BmnMWPC3();

	// Defines the action to be taken when a step is inside the
	// active volume. Creates BmnMWPC3Points and adds them to the collection.
...
private:
	...
	// Adds a BmnMWPC3Point to the HitCollection
  	BmnMWPC3Point* AddHit(Int_t trackID, Int_t detID, TVector3 pos, Double_t radius, TVector3 mom, Double_t time, 
...
//------------------------------------------------------------------------------------------------------------------------
inline void BmnMWPC3::ResetParameters() 
{
	fTrackID = -1;
	fVolumeID = fwheel = 0;

...
void CbmBmnStsDigitize::ApplyAlignment()
{
    ...
    for (Int_t iNode = 0; iNode < nStat0; iNode++)
    {
        ...
        TGeoRotation *r2 = new TGeoRotation("rot",0,0,0);
        ...
        TGeoNode* st_node = (TGeoNode*) sts->GetVolume()->GetNodes()->Last(); //AZ
    ...
    for (Int_t iNode = 0; iNode <nStat0; iNode++)
    {
        ...
        if (iNode > 2)
        {
            ...
            //cout<<" nModules: "<<GetNofModules(stationNode)<<endl;

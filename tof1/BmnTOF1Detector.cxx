...
Double_t BmnTOF1Detector::CalculateDt(Int_t Str = 0) {
    ...
    if (gSlew[Str] != NULL) dt = dt - gSlew[Str]->Eval(fWidth[Str]) + 15.0; // 21.782 ns is ToF of light for 6.53 meters (Distance between TOF400 and T0) , 15.0 ns for 4.5 meters

...
UniDbGeoConverter::UniDbGeoConverter()
{
}
// -------------------------------------------------------------------------

// hierarchical writing geometry data to database
int UniDbGeoConverter::RecursiveNodeChanging(TSQLServer* uni_db, TGeoNode* node, int parent_node_id)
{
...
int UniDbGeoConverter::WriteRootGeoToDB(TString geo_file_path)
{
    if (geo_file_path == "")
    {

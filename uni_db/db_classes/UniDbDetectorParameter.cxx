...
UniDbDetectorParameter::UniDbDetectorParameter(UniDbConnection* connUniDb, int run_number, TString detector_name, int parameter_id, unsigned char* parameter_value, Long_t size_parameter_value)
{
...
UniDbDetectorParameter* UniDbDetectorParameter::CreateDetectorParameter(int run_number, TString detector_name, int parameter_id, unsigned char* parameter_value, Long_t size_parameter_value)
{
	...
	return new UniDbDetectorParameter(connUniDb, tmp_run_number, tmp_detector_name, tmp_parameter_id, tmp_parameter_value, tmp_sz_parameter_value);
}

// -----   Get table record from database ---------------------------
UniDbDetectorParameter* UniDbDetectorParameter::GetDetectorParameter(int run_number, TString detector_name, int parameter_id)
{
	UniDbConnection* connUniDb = UniDbConnection::Open(UNIFIED_DB);
	if (connUniDb == 0x00) return 0x00;
...
int UniDbDetectorParameter::DeleteDetectorParameter(int run_number, TString detector_name, int parameter_id)
{
	UniDbConnection* connUniDb = UniDbConnection::Open(UNIFIED_DB);
	if (connUniDb == 0x00) return 0x00;
...
// Setters functions
int UniDbDetectorParameter::SetRunNumber(int run_number)
{
	if (!connectionUniDb)
	{
...
UniDbDetectorParameter* UniDbDetectorParameter::GetDetectorParameter(int run_number, TString detector_name, TString parameter_name)
{
    UniDbConnection* connUniDb = UniDbConnection::Open(UNIFIED_DB);
    if (connUniDb == 0x00) return 0x00;
...
UniDbDetectorParameter* UniDbDetectorParameter::CreateDetectorParameter(int run_number, TString detector_name, TString parameter_name, bool parameter_value)
{
    UniDbConnection* connUniDb = UniDbConnection::Open(UNIFIED_DB);
    if (connUniDb == 0x00) return 0x00;
    ...
    return new UniDbDetectorParameter(connUniDb, run_number, detector_name, parameter_id, (unsigned char*)p_parameter_value, size_parameter_value);
}

bool UniDbDetectorParameter::CreateDetectorParameters(int start_run_number, int end_run_number, TString detector_name, TString parameter_name, bool parameter_value)
{
    ...
    {
        UniDbDetectorParameter* pDetectorParameter = UniDbDetectorParameter::CreateDetectorParameter(i, detector_name, parameter_name, parameter_value);
...
UniDbDetectorParameter* UniDbDetectorParameter::CreateDetectorParameter(int run_number, TString detector_name, TString parameter_name, int parameter_value)
{
    UniDbConnection* connUniDb = UniDbConnection::Open(UNIFIED_DB);
    if (connUniDb == 0x00) return 0x00;
...
UniDbDetectorParameter* UniDbDetectorParameter::CreateDetectorParameter(int run_number, TString detector_name, TString parameter_name, double parameter_value)
{
    UniDbConnection* connUniDb = UniDbConnection::Open(UNIFIED_DB);
    if (connUniDb == 0x00) return 0x00;
...
UniDbDetectorParameter* UniDbDetectorParameter::CreateDetectorParameter(int run_number, TString detector_name, TString parameter_name, TString parameter_value)
{
    UniDbConnection* connUniDb = UniDbConnection::Open(UNIFIED_DB);
    if (connUniDb == 0x00) return 0x00;
...
UniDbDetectorParameter* UniDbDetectorParameter::CreateDetectorParameter(int run_number, TString detector_name, TString parameter_name, IIStructure* parameter_value, int element_count)
{
    UniDbConnection* connUniDb = UniDbConnection::Open(UNIFIED_DB);
    if (connUniDb == 0x00) return 0x00;
    ...
    return new UniDbDetectorParameter(connUniDb, run_number, detector_name, parameter_id, p_parameter_value, size_parameter_value);
}

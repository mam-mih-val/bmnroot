...
class UniDbDetectorParameter
{
 private:
	...
	//Constructor
	UniDbDetectorParameter(UniDbConnection* connUniDb, int value_id, TString detector_name, int parameter_id, int start_period, int start_run, int end_period, int end_run, int* dc_serial, int* channel, unsigned char* parameter_value, Long_t size_parameter_value);
 ...
 public:
	...
	static UniDbDetectorParameter* CreateDetectorParameter(TString detector_name, int parameter_id, int start_period, int start_run, int end_period, int end_run, int* dc_serial, int* channel, unsigned char* parameter_value, Long_t size_parameter_value);
	...
	/// get TDC/ADC parameter value
        static UniDbDetectorParameter* GetDetectorParameter(TString detector_name, TString parameter_name, int period_number, int run_number, int dc_serial, int channel);

	/// get channel count for TDC/ADC parameter value
        static int GetChannelCount(TString detector_name, TString parameter_name, int period_number, int run_number, int dc_serial);
	...
	// common function for adding common parameter value
        static UniDbDetectorParameter* CreateDetectorParameter(TString detector_name, TString parameter_name, int start_period, int start_run, int end_period, int end_run, unsigned char* parameter_value, Long_t size_parameter_value, enumParameterType enum_parameter_type);
	// common function for adding TDC/ADC parameter value
        static UniDbDetectorParameter* CreateDetectorParameter(TString detector_name, TString parameter_name, int start_period, int start_run, int end_period, int end_run, int dc_serial, int channel, unsigned char* parameter_value, Long_t size_parameter_value, enumParameterType enum_parameter_type);
	...
	/// add new record - detector parameter value as BOOL
        static UniDbDetectorParameter* CreateDetectorParameter(TString detector_name, TString parameter_name, int start_period, int start_run, int end_period, int end_run, bool parameter_value);
	/// add new record - TDC/ADC parameter value as BOOL
        static UniDbDetectorParameter* CreateDetectorParameter(TString detector_name, TString parameter_name, int start_period, int start_run, int end_period, int end_run, int dc_serial, int channel, bool parameter_value);
	...
	/// add new record - detector parameter value as INTEGER
        static UniDbDetectorParameter* CreateDetectorParameter(TString detector_name, TString parameter_name, int start_period, int start_run, int end_period, int end_run, int parameter_value);
	/// add new record - TDC/ADC parameter value as INTEGER
        static UniDbDetectorParameter* CreateDetectorParameter(TString detector_name, TString parameter_name, int start_period, int start_run, int end_period, int end_run, int dc_serial, int channel, int parameter_value);
	...
	/// add new record - detector parameter value as DOUBLE
        static UniDbDetectorParameter* CreateDetectorParameter(TString detector_name, TString parameter_name, int start_period, int start_run, int end_period, int end_run, double parameter_value);
	/// add new record - TDC/ADC parameter value as DOUBLE
        static UniDbDetectorParameter* CreateDetectorParameter(TString detector_name, TString parameter_name, int start_period, int start_run, int end_period, int end_run, int dc_serial, int channel, double parameter_value);
	...
	/// add new record - detector parameter value as STRING
        static UniDbDetectorParameter* CreateDetectorParameter(TString detector_name, TString parameter_name, int start_period, int start_run, int end_period, int end_run, TString parameter_value);
	/// add new record - detector parameter value as STRING
        static UniDbDetectorParameter* CreateDetectorParameter(TString detector_name, TString parameter_name, int start_period, int start_run, int end_period, int end_run, int dc_serial, int channel, TString parameter_value);
	...
	/// add new record - detector parameter value as Integer Array
        static UniDbDetectorParameter* CreateDetectorParameter(TString detector_name, TString parameter_name, int start_period, int start_run, int end_period, int end_run, int* parameter_value, int element_count);
	/// add new record - detector parameter value as Integer Array
        static UniDbDetectorParameter* CreateDetectorParameter(TString detector_name, TString parameter_name, int start_period, int start_run, int end_period, int end_run, int dc_serial, int channel, int* parameter_value, int element_count);
	...
	/// add new record - detector parameter value as Double Array
        static UniDbDetectorParameter* CreateDetectorParameter(TString detector_name, TString parameter_name, int start_period, int start_run, int end_period, int end_run, double* parameter_value, int element_count);
	/// add new record - detector parameter value as Double Array
        static UniDbDetectorParameter* CreateDetectorParameter(TString detector_name, TString parameter_name, int start_period, int start_run, int end_period, int end_run, int dc_serial, int channel, double* parameter_value, int element_count);
	...
	int SetDoubleArray(double* parameter_value, int element_count);
        ...
        static UniDbDetectorParameter* CreateDetectorParameter(TString detector_name, TString parameter_name, int start_period, int start_run, int end_period, int end_run, void* parameter_value, int byte_count);
        /// add new record - detector parameter value as Binary Array
        static UniDbDetectorParameter* CreateDetectorParameter(TString detector_name, TString parameter_name, int start_period, int start_run, int end_period, int end_run, int dc_serial, int channel, void* parameter_value, int byte_count);
	...
	/// add new record - detector parameter value as Int+Int Array
        static UniDbDetectorParameter* CreateDetectorParameter(TString detector_name, TString parameter_name, int start_period, int start_run, int end_period, int end_run, IIStructure* parameter_value, int element_count);
	/// add new record - detector parameter value as Int+Int Array
        static UniDbDetectorParameter* CreateDetectorParameter(TString detector_name, TString parameter_name, int start_period, int start_run, int end_period, int end_run, int dc_serial, int channel, IIStructure* parameter_value, int element_count);

...
UniDbMap1dim::UniDbMap1dim(UniDbConnection* connUniDb, int map_id, int map_row, TString serial_hex, int plane, int map_group, int slot, int channel_low, int channel_high)
{
...
UniDbMap1dim* UniDbMap1dim::CreateMap1dim(int map_id, int map_row, TString serial_hex, int plane, int map_group, int slot, int channel_low, int channel_high)
{
	...
	return new UniDbMap1dim(connUniDb, tmp_map_id, tmp_map_row, tmp_serial_hex, tmp_plane, tmp_map_group, tmp_slot, tmp_channel_low, tmp_channel_high);
}

// -----   Get table record from database ---------------------------
UniDbMap1dim* UniDbMap1dim::GetMap1dim(int map_id, int map_row)
{
	UniDbConnection* connUniDb = UniDbConnection::Open(UNIFIED_DB);
	if (connUniDb == 0x00) return 0x00;
...
int UniDbMap1dim::DeleteMap1dim(int map_id, int map_row)
{
	UniDbConnection* connUniDb = UniDbConnection::Open(UNIFIED_DB);
	if (connUniDb == 0x00) return 0x00;
...
// Setters functions
int UniDbMap1dim::SetMapId(int map_id)
{
	if (!connectionUniDb)
	{
...
int UniDbMap1dim::SetMapRow(int map_row)
{
	if (!connectionUniDb)
	{
		cout<<"Connection object is null"<<endl;
...
int UniDbMap1dim::SetSerialHex(TString serial_hex)
{
	if (!connectionUniDb)
	{
		cout<<"Connection object is null"<<endl;
...
int UniDbMap1dim::SetPlane(int plane)
{
	if (!connectionUniDb)
	{
		cout<<"Connection object is null"<<endl;
...
int UniDbMap1dim::SetMapGroup(int map_group)
{
	if (!connectionUniDb)
	{
		cout<<"Connection object is null"<<endl;
...
int UniDbMap1dim::SetSlot(int slot)
{
	if (!connectionUniDb)
	{
		cout<<"Connection object is null"<<endl;
...
int UniDbMap1dim::SetChannelLow(int channel_low)
{
	if (!connectionUniDb)
	{
		cout<<"Connection object is null"<<endl;
...
int UniDbMap1dim::SetChannelHigh(int channel_high)
{
	if (!connectionUniDb)
	{
		cout<<"Connection object is null"<<endl;

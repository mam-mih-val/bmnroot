...
UniDbMap2dim::UniDbMap2dim(UniDbConnection* connUniDb, int map_id, int map_row, TString serial_hex, int channel, int f_channel, int channel_size, int x, int y, int is_connected)
{
...
UniDbMap2dim* UniDbMap2dim::CreateMap2dim(int map_id, int map_row, TString serial_hex, int channel, int f_channel, int channel_size, int x, int y, int is_connected)
{
	...
	return new UniDbMap2dim(connUniDb, tmp_map_id, tmp_map_row, tmp_serial_hex, tmp_channel, tmp_f_channel, tmp_channel_size, tmp_x, tmp_y, tmp_is_connected);
}

// -----   Get table record from database ---------------------------
UniDbMap2dim* UniDbMap2dim::GetMap2dim(int map_id, int map_row)
{
	UniDbConnection* connUniDb = UniDbConnection::Open(UNIFIED_DB);
	if (connUniDb == 0x00) return 0x00;
...
int UniDbMap2dim::DeleteMap2dim(int map_id, int map_row)
{
	UniDbConnection* connUniDb = UniDbConnection::Open(UNIFIED_DB);
	if (connUniDb == 0x00) return 0x00;
...
// Setters functions
int UniDbMap2dim::SetMapId(int map_id)
{
	if (!connectionUniDb)
	{
...
int UniDbMap2dim::SetMapRow(int map_row)
{
	if (!connectionUniDb)
	{
		cout<<"Connection object is null"<<endl;
...
int UniDbMap2dim::SetSerialHex(TString serial_hex)
{
	if (!connectionUniDb)
	{
		cout<<"Connection object is null"<<endl;
...
int UniDbMap2dim::SetChannel(int channel)
{
	if (!connectionUniDb)
	{
		cout<<"Connection object is null"<<endl;
...
int UniDbMap2dim::SetFChannel(int f_channel)
{
	if (!connectionUniDb)
	{
		cout<<"Connection object is null"<<endl;
...
int UniDbMap2dim::SetChannelSize(int channel_size)
{
	if (!connectionUniDb)
	{
		cout<<"Connection object is null"<<endl;
...
int UniDbMap2dim::SetIsConnected(int is_connected)
{
	if (!connectionUniDb)
	{
		cout<<"Connection object is null"<<endl;

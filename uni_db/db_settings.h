...
const char* const UNI_DB_HOST = "vm221-53.jinr.ru";     // for database adninistrator only
...
const char* const TANGO_DB_HOST = "10.18.11.66";        // for database adninistrator only

...
void set_root_geometry(char* root_file_path, int start_run, int end_run)
{
    ...
    int res_code = UniDbRun::SetRootGeometry(start_run, end_run, buffer, file_size); //(int start_run_number, int end_run_number, unsigned char* root_geometry, Long_t size_root_geometry)
